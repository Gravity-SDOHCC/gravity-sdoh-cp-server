...
public class AuthorizationController {
	...
	public ResponseEntity<String> postAuthorization(
		...
		return AuthorizationEndpoint.handleAuthorizationPost(
				entity, aud, scope, state, clientId, redirectURI, responseType, appProperties.getServer_address());
	}
	...
	public ResponseEntity<String> postAccessToken(
		...
		return TokenEndpoint.handleTokenRequest(
				request, grantType, code, redirectURI, appProperties.getServer_address());
	}
	...
	public ResponseEntity<String> postRefreshToken(
		...
		return TokenEndpoint.handleTokenRequest(
				request, grantType, refreshToken, null, appProperties.getServer_address());
	}
